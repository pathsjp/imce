 ...
 * @group imce
 */
class ImceHelpControllerTest extends BrowserTestBase {
  ...
  public static function getInfo() {
    return [
      ...
      'description' => 'Test Unit for module imce and controller ImceHelpController.',
      'group' => 'imce',
    ];
  }
  ...
  public function testImceBrowserController() {
    $this->drupalGet(Url::fromRoute('imce.help'));
